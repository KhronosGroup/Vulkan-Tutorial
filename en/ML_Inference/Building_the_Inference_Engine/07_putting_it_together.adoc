...
xref:ML_Inference/Building_the_Inference_Engine/06_nnef_deep_dive.adoc[Previous: NNEF Deep Dive] | xref:ML_Inference/Debugging_and_Performance/01_introduction.adoc[Next: Debugging and Performance]
