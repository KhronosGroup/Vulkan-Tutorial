...
[NOTE]
====
We covered PBR material theory and shader details earlier in link:05_pbr_rendering.adoc[PBR Rendering], so we won't restate that here. This section focuses on the wiring: how material properties are packed into push constants and consumed by the draw call in this chapter's context.
====
