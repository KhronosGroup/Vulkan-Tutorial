...
xref:Advanced_Vulkan_Compute/03_Memory_Models/02_vulkan_memory_model.adoc[Previous: The Vulkan Memory Model] | xref:Advanced_Vulkan_Compute/03_Memory_Models/04_memory_consistency.adoc[Next: Memory Consistency]