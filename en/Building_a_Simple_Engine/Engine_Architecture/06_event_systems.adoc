...
xref:Building_a_Simple_Engine/Engine_Architecture/05_rendering_pipeline.adoc[Previous: Rendering Pipeline] | xref:Building_a_Simple_Engine/Engine_Architecture/conclusion.adoc[Next: Conclusion]
