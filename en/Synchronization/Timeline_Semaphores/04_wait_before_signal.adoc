...
Previous: xref:Synchronization/Timeline_Semaphores/03_monotonic_counter.adoc[The Monotonic Counter] | Next: xref:Synchronization/Frame_in_Flight/01_introduction.adoc[Frame-in-Flight Architecture]
