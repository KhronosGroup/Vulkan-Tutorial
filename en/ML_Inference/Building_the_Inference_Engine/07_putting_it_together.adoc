...
xref:ML_Inference/Building_the_Inference_Engine/06_nnef_introduction.adoc[Previous: NNEF Introduction] | xref:ML_Inference/Debugging_and_Performance/01_introduction.adoc[Next: Debugging and Performance]
