...
class Engine
{
  public:
	 ...
	 * @param debugSync Whether to enable Vulkan synchronization validation.
	 * @return True if initialization was successful, false otherwise.
	 */
	bool Initialize(const std::string &appName, int width, int height, bool enableValidationLayers = true, bool debugSync = false);
 ...
 * @return True if initialization was successful, false otherwise.
 */
	bool InitializeAndroid(android_app *app, const std::string &appName, bool enableValidationLayers = true, bool debugSync = false);
