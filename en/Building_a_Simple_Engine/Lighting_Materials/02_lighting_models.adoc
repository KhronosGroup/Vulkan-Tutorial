...
xref:Building_a_Simple_Engine/Lighting_Materials/01_introduction.adoc[Previous: Introduction] | xref:Building_a_Simple_Engine/Lighting_Materials/03_push_constants.adoc[Next: Push Constants]
