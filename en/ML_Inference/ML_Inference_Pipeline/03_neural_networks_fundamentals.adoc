...
image::images/ML_Inference/ML_Inference_Pipeline/biological_neuron.png[A biological neuron showing dendrites, cell body, and axon]
...
image::images/ML_Inference/ML_Inference_Pipeline/linear_perceptron.png[An artificial neuron (perceptron) with three inputs and one output]
...
image::images/ML_Inference/ML_Inference_Pipeline/neural_network_example.png[A simple neural network with input layer, hidden layer, and output layer]
...
image::images/ML_Inference/ML_Inference_Pipeline/basic_and_node.png[A single neuron implementing an AND gate with sigmoid activation]
