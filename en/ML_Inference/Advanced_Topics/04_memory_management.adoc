...
image::images/tensor_liveness.svg[Diagram showing non-overlapping tensor intervals sharing the same memory offset, 600]
...
xref:03_vendor_optimizations.adoc[Previous: Vendor-Specific Optimizations] | xref:05_model_optimization.adoc[Next: Model Optimization Techniques]
