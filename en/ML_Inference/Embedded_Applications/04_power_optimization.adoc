...
image::images/thermal_pid_loop.svg[Diagram showing the feedback loop between SoC temperature and inference duty cycle, 800]
...
xref:03_camera_integration.adoc[Previous: Camera Integration] | xref:05_complete_example.adoc[Next: Complete Example]
