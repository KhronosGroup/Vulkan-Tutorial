...
xref:Building_a_Simple_Engine/Subsystems/01_introduction.adoc[Previous: Introduction] | xref:Building_a_Simple_Engine/Subsystems/03_vulkan_audio.adoc[Next: Vulkan for Audio Processing]
