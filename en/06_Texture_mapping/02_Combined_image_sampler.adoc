...
.Adding the combined image sampler binding
----
// START c++
...
[source,multilang,c++,c]
.DescriptorImageInfo for the combined image sampler
----
// START c++
...
[source,multilang,c++,c]
.Vertex struct with texture coordinates
----
// START c++
struct Vertex
{
...
void getAttributeDescriptions(VkVertexInputAttributeDescription attributeDescriptions[3])
{
