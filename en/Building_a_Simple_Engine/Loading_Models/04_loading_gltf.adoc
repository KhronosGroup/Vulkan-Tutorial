...
xref:Building_a_Simple_Engine/Loading_Models/03_model_system.adoc[Previous: Implementing the Model Loading System] | xref:Building_a_Simple_Engine/Loading_Models/05_pbr_rendering.adoc[Next: Implementing PBR Rendering]
