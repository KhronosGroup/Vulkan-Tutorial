...
** Clang and ninja (tested on clang-17 to clang-21 and ninja 1.11)
* CMake 3.26 or newer
* Git (to download dependencies)
* Vulkan SDK (tested on 1.4.357)
* +slangc+, either on +PATH+ or supplied with +-DSLANGC_EXECUTABLE=...+ (tested with version 2026.8)
