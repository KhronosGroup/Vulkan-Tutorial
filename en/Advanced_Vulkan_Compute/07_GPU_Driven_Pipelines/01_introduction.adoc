...
xref:../06_Advanced_Data_Structures/04_device_addressable_buffers.adoc[Previous: Device-Addressable Buffers] | xref:02_indirect_dispatch.adoc[Next: Indirect Dispatch]
