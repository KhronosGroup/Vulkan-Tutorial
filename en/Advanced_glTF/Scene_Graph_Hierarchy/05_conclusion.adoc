...
xref:04_metadata_and_physics_extras.adoc[Previous: Metadata & Physics Extras] | xref:../Skeletal_Compute_Skinning/01_introduction.adoc[Next: Skeletal & Compute Skinning Introduction]
