...
xref:Advanced_Vulkan_Compute/10_Performance_Optimization/01_introduction.adoc[Previous: Introduction] | xref:Advanced_Vulkan_Compute/10_Performance_Optimization/03_divergence_audit.adoc[Next: Divergence Audit]
