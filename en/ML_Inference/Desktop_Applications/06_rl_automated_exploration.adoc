...
image::images/rnd_diagram.svg[RND diagram showing Target and Predictor networks and how prediction error generates a reward,800]
...
image::images/rl_system_architecture.svg[Architecture diagram showing the loop between Vulkan App, RL Agent, and RND Module,800]
...
xref:05_real_time_camera.adoc[Previous: Real-Time Camera Integration] | xref:07_ray_tracing_optimization.adoc[Next: Ray Tracing Optimization]
