...
As we saw in the xref:03_model_system.adoc[Model System chapter], our engine uses several structures to represent animations:
...
xref:07_scene_rendering.adoc[Previous: Rendering the Scene] | xref:09_conclusion.adoc[Next: Conclusion]
