...
image::images/zero_copy_pipeline.svg[Diagram showing physical memory sharing between V4L2 sensor and Vulkan GPU via dmabuf, 800]
...
xref:02_cross_compilation.adoc[Previous: Cross-Compilation] | xref:04_power_optimization.adoc[Next: Power Optimization]
