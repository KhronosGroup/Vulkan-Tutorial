...
xref:ML_Inference/Desktop_Applications/07_ray_tracing_optimization.adoc[Previous: Ray Tracing Optimization] | xref:ML_Inference/Advanced_Topics/01_introduction.adoc[Next: Advanced Topics]
