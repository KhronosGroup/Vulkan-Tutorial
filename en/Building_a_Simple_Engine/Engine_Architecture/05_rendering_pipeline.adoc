...
xref:Building_a_Simple_Engine/Engine_Architecture/04_resource_management.adoc[Previous: Resource Management] | xref:Building_a_Simple_Engine/Engine_Architecture/06_event_systems.adoc[Next: Event Systems]
