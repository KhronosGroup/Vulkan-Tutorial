...
xref:Building_a_Simple_Engine/Mobile_Development/04_rendering_approaches.adoc[Previous: Rendering Approaches] | xref:Building_a_Simple_Engine/Mobile_Development/06_conclusion.adoc[Next: Conclusion]
