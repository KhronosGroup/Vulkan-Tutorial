...
.Synchronization object class members
----
// START c++
...
void createSyncObjects()
{
  ...
  if (vkCreateSemaphore(device, &semaphoreInfo, nullptr, &presentCompleteSemaphore) != VK_SUCCESS ||
      vkCreateSemaphore(device, &semaphoreInfo, nullptr, &renderFinishedSemaphore) != VK_SUCCESS ||
      vkCreateFence(device, &fenceInfo, nullptr, &drawFence) != VK_SUCCESS) {
...
// START c
if (vkQueueSubmit(queue, 1, &submitInfo, drawFence) != VK_SUCCESS) {
...
[source,multilang,c++,c]
.Waiting for the device to become idle before exiting
----
// START c++
void mainLoop() {
    while (!glfwWindowShouldClose(window)) {
