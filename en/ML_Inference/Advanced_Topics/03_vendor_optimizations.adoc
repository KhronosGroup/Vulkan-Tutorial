...
image::images/coop_matrix_warp.svg[Diagram showing Matrix A and B distribution across a GPU Warp for hardware acceleration, 800]
...
xref:02_quantization_strategies.adoc[Previous: Quantization Strategies] | xref:04_memory_management.adoc[Next: Advanced Memory Management]
