...
=== Resource Initialization: Core Vulkan Resources
...
xref:Building_a_Simple_Engine/GUI/01_introduction.adoc[Previous: Introduction] | xref:Building_a_Simple_Engine/GUI/03_input_handling.adoc[Next: Input Handling]
