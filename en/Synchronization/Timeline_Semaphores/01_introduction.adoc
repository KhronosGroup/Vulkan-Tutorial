...
Previous: xref:../Pipeline_Barriers_Transitions/04_global_vs_local_barriers.adoc[Global vs. Local Barriers] | Next: xref:02_unifying_sync.adoc[Unifying Synchronization]
