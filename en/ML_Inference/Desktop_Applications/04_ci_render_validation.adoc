...
xref:ML_Inference/Desktop_Applications/03_practical_implementation.adoc[Previous: CPU Baseline Implementation] | xref:ML_Inference/Desktop_Applications/05_real_time_camera.adoc[Next: Real-Time Camera Integration]
