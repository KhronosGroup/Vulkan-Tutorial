...
xref:Building_a_Simple_Engine/Loading_Models/02_project_setup.adoc[Previous: Setting Up the Project] | xref:Building_a_Simple_Engine/Loading_Models/04_loading_gltf.adoc[Next: Loading a glTF Model]
