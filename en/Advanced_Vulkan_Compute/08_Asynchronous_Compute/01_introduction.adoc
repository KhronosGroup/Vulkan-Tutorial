...
xref:../07_GPU_Driven_Pipelines/04_multi_draw_indirect_mdi.adoc[Previous: Multi-Draw Indirect (MDI)] | xref:02_concurrent_execution.adoc[Next: Concurrent Execution]
