...
xref:Advanced_Vulkan_Compute/08_Asynchronous_Compute/04_queue_priority.adoc[Previous: Queue Priority] | xref:Advanced_Vulkan_Compute/09_Specialized_Math/02_cooperative_matrices.adoc[Next: Cooperative Matrices]
