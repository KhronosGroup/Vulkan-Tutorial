...
[NOTE]
====
We won’t re-explain PBR theory or push-constant fundamentals here. See xref:Building_a_Simple_Engine/Lighting_Materials/03_push_constants.adoc[push constants], and xref:Building_a_Simple_Engine/Lighting_Materials/01_introduction.adoc[Introduction] (and xref:Building_a_Simple_Engine/Loading_Models/05_pbr_rendering.adoc[PBR Rendering]) for PBR concepts.
====
...
xref:Building_a_Simple_Engine/Lighting_Materials/04_lighting_implementation.adoc[Previous: Lighting Implementation] | xref:Building_a_Simple_Engine/Lighting_Materials/07_shadows.adoc[Next: Shadows]
