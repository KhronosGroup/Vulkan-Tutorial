...
xref:Building_a_Simple_Engine/GUI/02_imgui_setup.adoc[Previous: Setting Up Dear ImGui] | xref:Building_a_Simple_Engine/GUI/04_ui_elements.adoc[Next: UI Elements]
