...
(CLA)](https://www.khronos.org/cla/KhronosGroup/Vulkan-Tutorial), to confirm you
own your work and are granting Khronos the necessary permissions to redistribute
