...
xref:Advanced_Vulkan_Compute/10_Performance_Optimization/03_divergence_audit.adoc[Previous: Divergence Audit] | xref:Advanced_Vulkan_Compute/11_Diagnostics_and_Refinement/02_compute_validation.adoc[Next: Compute Validation]
