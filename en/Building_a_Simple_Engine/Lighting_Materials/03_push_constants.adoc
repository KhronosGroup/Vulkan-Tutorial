...
xref:Building_a_Simple_Engine/Lighting_Materials/02_lighting_models.adoc[Previous: Lighting Models] | xref:Building_a_Simple_Engine/Lighting_Materials/04_lighting_implementation.adoc[Next: Lighting Implementation]
