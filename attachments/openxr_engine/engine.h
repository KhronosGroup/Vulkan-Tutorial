...
class Engine
{
  public:
	 ...
	 */
	bool Initialize(const std::string &appName, int width, int height, bool enableValidationLayers = true, bool useXR = false);
 ...
 */
#	if defined(NDEBUG)
	bool InitializeAndroid(android_app *app, const std::string &appName, bool enableValidationLayers = false, bool useXR = false);
#	else
	bool InitializeAndroid(android_app *app, const std::string &appName, bool enableValidationLayers = true, bool useXR = false);
#	endif
  ...
  private:
	...
	/**
	 * @brief Update the engine state for XR.
	 * @param predictedTime The predicted display time from OpenXR.
	 */
	void Update(XrTime predictedTime);
	...
	/**
	 * @brief Render the scene for XR.
	 * @param predictedTime The predicted display time from OpenXR.
	 */
	void Render(XrTime predictedTime);
