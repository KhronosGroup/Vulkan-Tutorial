...
[source,multilang,c++,c]
.generateMipmaps signature and the reusable barrier
----
// START c++
...
[source,multilang,c++,c]
.Transitioning level i-1 to transfer-src
----
// START c++
...
blit.dstOffsets[1].x = 1 < mipWidth ? mipWidth / 2 : 1;
blit.dstOffsets[1].y = 1 < mipHeight ? mipHeight / 2 : 1;
...
[source,multilang,c++,c]
.Transitioning level i-1 to shader-read-only
----
// START c++
...
[source,multilang,c++,c]
.Transitioning the last mip level
----
// START c++
...
[source,multilang,c++,c]
.Querying format properties for linear blit support
----
// START c++
void generateMipmaps(vk::raii::CommandBuffer &commandBuffer,
                     vk::raii::Image         &image,
...
[source,multilang,c++,c]
.Checking for linear filtering support
----
// START c++
...
[source,multilang,c++,c]
.The complete sampler for mipmapped sampling
----
// START c++
...
[source,multilang,c++,c]
.Forcing the sampler to skip the lowest mip levels
----
// START c++
