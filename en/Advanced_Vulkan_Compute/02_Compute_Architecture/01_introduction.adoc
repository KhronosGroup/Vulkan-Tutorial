...
xref:Advanced_Vulkan_Compute/introduction.adoc[Previous: Introduction] | xref:Advanced_Vulkan_Compute/02_Compute_Architecture/02_workgroups_and_invocations.adoc[Next: Workgroups and Invocations]
