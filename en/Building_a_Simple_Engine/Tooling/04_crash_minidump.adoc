...
xref:03_debugging_and_renderdoc.adoc[Previous: Debugging with VK_KHR_debug_utils and RenderDoc] | xref:05_extensions.adoc[Next: Vulkan Extensions for Robustness]
