...
xref:ML_Inference/Embedded_Applications/01_introduction.adoc[Previous: Introduction] | xref:ML_Inference/Embedded_Applications/03_camera_integration.adoc[Next: Camera Integration]
