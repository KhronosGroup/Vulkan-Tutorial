...
xref:Building_a_Simple_Engine/Lighting_Materials/06_conclusion.adoc[Previous: Lighting & Materials Conclusion] | xref:Building_a_Simple_Engine/GUI/02_imgui_setup.adoc[Next: Setting Up Dear ImGui]
