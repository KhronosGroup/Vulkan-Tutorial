...
Previous: xref:Synchronization/Synchronization_Validation/03_interpreting_vuids.adoc[Interpreting VUIDs] | Next: xref:Synchronization/Profiling_Optimization/02_barrier_batching.adoc[Barrier Batching]
