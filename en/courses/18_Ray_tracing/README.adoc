...
* **Slides available**: link:https://github.com/KhronosGroup/Vulkan-Tutorial/blob/main/attachments/Vulkan%20Ray%20Tracing%20With%20Dynamic%20Rendering.pdf[here].
