...
image::images/camera_pipeline_diagram.svg[Diagram showing the Producer-Consumer pipeline between camera capture, inference, and rendering,800]
...
xref:04_ci_render_validation.adoc[Previous: CI/CD Render Validation] | xref:06_rl_automated_exploration.adoc[Next: RL-Based Automated Exploration]
