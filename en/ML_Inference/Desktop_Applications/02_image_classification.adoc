...
xref:ML_Inference/Desktop_Applications/01_introduction.adoc[Previous: Desktop Applications Introduction] | xref:ML_Inference/Desktop_Applications/03_practical_implementation.adoc[Next: CPU Baseline Implementation]
