...
xref:Building_a_Simple_Engine/GUI/03_input_handling.adoc[Previous: Input Handling] | xref:Building_a_Simple_Engine/GUI/05_vulkan_integration.adoc[Next: Vulkan Integration]
