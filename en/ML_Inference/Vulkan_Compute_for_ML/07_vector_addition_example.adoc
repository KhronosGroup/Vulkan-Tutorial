...
xref:ML_Inference/Vulkan_Compute_for_ML/06_synchronization.adoc[Previous: Synchronization] | xref:ML_Inference/Models_and_Data/01_introduction.adoc[Next: Models and Data]
