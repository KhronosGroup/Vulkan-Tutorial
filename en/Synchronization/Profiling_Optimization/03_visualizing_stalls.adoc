...
Previous: xref:Synchronization/Profiling_Optimization/02_barrier_batching.adoc[Barrier Batching] | Next: xref:Synchronization/introduction.adoc[Back to Introduction]
