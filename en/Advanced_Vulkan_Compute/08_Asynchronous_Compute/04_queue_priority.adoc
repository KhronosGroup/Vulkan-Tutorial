...
xref:Advanced_Vulkan_Compute/08_Asynchronous_Compute/03_timeline_semaphores.adoc[Previous: Timeline Semaphores] | xref:Advanced_Vulkan_Compute/09_Specialized_Math/01_introduction.adoc[Next: Specialized Math]
