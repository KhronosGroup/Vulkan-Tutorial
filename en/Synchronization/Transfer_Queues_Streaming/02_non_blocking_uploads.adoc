...
=== Identifying the Transfer Queue
...
Previous: xref:Synchronization/Transfer_Queues_Streaming/01_introduction.adoc[Introduction] | Next: xref:Synchronization/Transfer_Queues_Streaming/03_staging_sync.adoc[Staging Synchronization]
