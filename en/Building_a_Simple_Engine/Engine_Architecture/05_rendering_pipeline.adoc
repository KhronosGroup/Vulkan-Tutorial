...
For detailed information about advanced rendering techniques such as Deferred Rendering, Forward+ Rendering, and Physically Based Rendering (PBR), please refer to the xref:../Appendix/appendix.adoc#advanced-rendering-techniques[Advanced Rendering Techniques] section in the Appendix. This section includes references to valuable resources for further reading.
...
xref:04_resource_management.adoc[Previous: Resource Management] | xref:06_event_systems.adoc[Next: Event Systems]
