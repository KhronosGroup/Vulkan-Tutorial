...
*Cross-Platform*: ONNX Runtime works on all platforms. On Windows, it uses DirectML. On Linux, it uses OpenCL or CPU. On mobile, it uses platform-specific backends. Your code is portable.
