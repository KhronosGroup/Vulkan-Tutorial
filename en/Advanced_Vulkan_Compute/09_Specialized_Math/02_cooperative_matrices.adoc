...
xref:Advanced_Vulkan_Compute/09_Specialized_Math/01_introduction.adoc[Previous: Introduction] | xref:Advanced_Vulkan_Compute/09_Specialized_Math/03_mixed_precision.adoc[Next: Mastering Mixed Precision]
