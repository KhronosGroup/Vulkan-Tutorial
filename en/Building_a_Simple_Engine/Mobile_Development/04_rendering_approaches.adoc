...
xref:Building_a_Simple_Engine/Mobile_Development/03_performance_optimizations.adoc[Previous: Performance Optimizations] | xref:Building_a_Simple_Engine/Mobile_Development/05_vulkan_extensions.adoc[Next: Vulkan Extensions for Mobile]
