...
xref:Building_a_Simple_Engine/Loading_Models/05_pbr_rendering.adoc[Previous: Understanding Physically Based Rendering] | xref:Building_a_Simple_Engine/Loading_Models/07_scene_rendering.adoc[Next: Rendering the Scene]
