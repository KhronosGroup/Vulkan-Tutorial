...
xref:Advanced_glTF/Scene_Graph_Heiarchy/04_metadata_and_physics_extras.adoc[Previous: Metadata & Physics Extras] | xref:Advanced_glTF/Skeletal_Compute_Skinning/01_introduction.adoc[Next: Skeletal & Compute Skinning Introduction]
