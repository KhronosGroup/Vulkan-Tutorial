...
xref:Building_a_Simple_Engine/Subsystems/03_vulkan_audio.adoc[Previous: Vulkan for Audio Processing] | xref:Building_a_Simple_Engine/Subsystems/05_vulkan_physics.adoc[Next: Vulkan for Physics Simulation]
