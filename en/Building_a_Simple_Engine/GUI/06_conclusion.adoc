...
xref:Building_a_Simple_Engine/GUI/05_vulkan_integration.adoc[Previous: Vulkan Integration] | xref:Building_a_Simple_Engine/Loading_Models/01_introduction.adoc[Next: Loading Models]
