...
xref:02_instruction_throughput.adoc[Previous: Instruction Throughput Analysis] | xref:../11_Diagnostics_and_Refinement/01_introduction.adoc[Next: Diagnostics and Refinement]
