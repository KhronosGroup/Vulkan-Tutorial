...
image::images/quantization_mapping.svg[Diagram showing mapping from continuous float range to discrete integer points, 600]
...
xref:01_introduction.adoc[Previous: Introduction] | xref:03_vendor_optimizations.adoc[Next: Vendor-Specific Optimizations]
