...
xref:Building_a_Simple_Engine/Lighting_Materials/05_vulkan_integration.adoc[Previous: Vulkan Integration] | xref:Building_a_Simple_Engine/Lighting_Materials/06_conclusion.adoc[Next: Conclusion]
