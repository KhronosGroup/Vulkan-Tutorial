...
[source,multilang,c++,c]
.beginSingleTimeCommands and endSingleTimeCommands
----
// START c++
...
[source,multilang,c++,c]
.Recording the buffer-to-image copy
----
// START c++
...
[source,multilang,c++,c]
.Determining access masks and pipeline stages for the transition
----
// START c++
