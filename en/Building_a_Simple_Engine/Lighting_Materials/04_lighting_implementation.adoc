...
xref:Building_a_Simple_Engine/Lighting_Materials/03_push_constants.adoc[Previous: Push Constants] | xref:Building_a_Simple_Engine/Lighting_Materials/05_vulkan_integration.adoc[Next: Vulkan Integration]
